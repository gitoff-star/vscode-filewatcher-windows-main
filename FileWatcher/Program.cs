    ...
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            var processor = new EventProcessor((e) => {
                Console.WriteLine("new event change detected");
                ...
                Console.WriteLine("new change detected");
            ...
            var thread = new Thread(() =>
            {
                while (true)
                {
                    ...
                    if (verboseLogging)
                    {
                        Console.WriteLine("new change detected here");
            ...
            Action<ErrorEventArgs> onError = (e) =>
            {
                if (e != null)
                {
                    Console.WriteLine("new change detected 0,1");
